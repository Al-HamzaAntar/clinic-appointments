  ...
  return (
    <section className="bg-primary py-16 px-6 md:px-12 flex flex-col md:flex-row items-center justify-between rounded-xl max-w-6xl mx-auto">
      <div className="text-white max-w-lg">
        ...
        className="mt-4 bg-white text-primary font-semibold py-2 px-6 rounded-full shadow-md hover:bg-gray-100 transition"
        >
          Create account 
        </button>
      </div>
      ...
      <div className="hidden md:block mt-6 h-24 md:mt-0">
        <img
